...
RecentPopularShows = Shows
  .reject do |show|
    show.score < 8.0 || show.votes < 5_000 || !show.date.end.nil? && show.date.last < 2017 || show.genres.any? { |genre| %w[Animation Biography Reality Talk Documentary].include?(genre) }
